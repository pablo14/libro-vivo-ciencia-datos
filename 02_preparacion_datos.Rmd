...
- `data_bins`: data frame que devolvió la función 
`discretize_get_bins`. Si el usuario la modifica, entonces cada límite superior deberá estar separado por un carácter pipe (`|`) como se ve en el ejemplo.
...
nrow(heart_disease) # número de filas antes de la exclusión
nrow(heart_disease_clean) # número de filas después de la exclusión
```
