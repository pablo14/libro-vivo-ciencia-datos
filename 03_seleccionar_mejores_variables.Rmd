...
Consideren la siguiente tabla de _big data_ `r emo::ji("stuck_out_tongue_winking_eye")`  4 filas, 2 variables de entrada (`var_1`, `var_2`) y un resultado (`target`):
...
Pensaríamos... _"¡Dios mío! ¿Necesito el paraguas o no `r emo::ji("scream")`?"_
...
```{r cross-plot-feature-engineering, results="hide",fig.height=4, fig.width=9.5, fig.cap="Variable numérica como dato de entrada (segmentación automática)", out.extra=""}
